...
typedef struct {
    ...
    MetricCounter security_headers_sent_total;
    MetricCounter cors_headers_sent_total;
    MetricCounter per_ip_limit_rejected_total;
    MetricGauge active_connections;
    MetricGauge ip_limiter_entries_total;
